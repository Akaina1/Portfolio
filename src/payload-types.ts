...
export interface AnimateTextBlock {
  /**
   * Enter the text content you want to animate
   */
  text: string;
  /**
  ...
  /**
   * Select the animation style to apply to the text
   */
...
export interface HighlightTextBlock {
  /**
   * Enter the text that will be highlighted on scroll
   */
  text: string;
  /**
   * Enter Tailwind classes for light mode highlight effect
   */
  highlightStyleLight: string;
  /**
   * Enter Tailwind classes for dark mode highlight effect
   */
